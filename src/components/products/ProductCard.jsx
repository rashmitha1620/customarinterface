...
+    <div className="group bg-white rounded-lg shadow-sm border hover:shadow-lg transition-all duration-300 overflow-hidden product-card-hover h-full flex flex-col">
       {/* Product Image */}
...
+          <div className="absolute top-1 md:top-2 left-1 md:left-2 bg-red-500 text-white px-1 md:px-2 py-0.5 rounded text-xs font-medium">
             {discount}% OFF
           </div>
         )}
...
+        <div className="absolute top-1 md:top-2 right-1 md:right-2 flex flex-col space-y-1 opacity-0 group-hover:opacity-100 transition-opacity">
+          <button className="p-1 md:p-1.5 bg-white rounded-full shadow-md hover:bg-gray-50">
...
+          <button className="p-1 md:p-1.5 bg-white rounded-full shadow-md hover:bg-gray-50">
+            <Eye className="w-3 h-3 md:w-4 md:h-4 text-gray-600 hover:text-emerald-500" />
           </button>
         </div>
         {!product.inStock && (
...
+          <h3 className="font-medium text-xs sm:text-sm md:text-base text-gray-900 line-clamp-2 flex-1 mr-1 md:mr-2">
             {product.name}
           </h3>
-          <div className="flex items-center space-x-1 text-sm">
-            <Star className="w-3 h-3 md:w-4 md:h-4 text-yellow-400 fill-current" />
-            <span className="text-xs md:text-sm text-gray-600">{product.rating}</span>
+          <div className="flex items-center space-x-0.5 md:space-x-1 text-sm flex-shrink-0">
...
+        <p className="text-xs text-gray-500 mb-1 md:mb-2 line-clamp-1">{product.vendor}</p>
...
+          className={`w-full flex items-center justify-center space-x-1 md:space-x-2 px-2 md:px-4 py-1.5 md:py-2 rounded-lg text-xs sm:text-sm md:text-base font-medium transition-colors ${
             product.inStock
...
+                  className="text-xs bg-emerald-50 text-emerald-600 px-1 md:px-2 py-0.5 rounded"
                 >
                   {feature}
                 </span>